...
import { StatusBadge, RECORD_STATUS_LABEL } from "@/features/intake/ui/StatusBadge"
...
import { MemoDialog } from "@/features/inspectionDetail/ui/MemoDialog"
import { UnsavedChangesDialog } from "@/features/inspectionDetail/ui/UnsavedChangesDialog"
...
export function InspectionDetailPage() {
    ...
    function handleMemoSubmit(memo: string) {
        ...
        resolveRecord(record!.recordId, memoDialog === "CONFIRM" ? "CONFIRMED" : "REJECTED", memo)
