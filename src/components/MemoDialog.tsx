        ...
        >
            <div className="w-full max-w-md rounded-xl bg-white p-5 shadow-lg">
                ...
                <textarea
                    ...
                    className="w-full resize-none rounded-xl border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary-100"
                />
